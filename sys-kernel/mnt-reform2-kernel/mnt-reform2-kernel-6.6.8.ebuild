...
REFORM_CONFIG_HASH=d4bbc527b264a4cc7fefb20ee2459c84a2154c3c

DESCRIPTION="Linux kernel built with Gentoo and MNT reform patches"
HOMEPAGE="
...
src_prepare() {
	local PATCHES=(
		...
		"${WORKDIR}"/*.patch
		"${WORKDIR}"/reform-debian-packages-${REFORM_CONFIG_HASH}/linux/patches${MY_P%.*}/*.patch
	)
	default
